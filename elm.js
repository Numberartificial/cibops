...
var _ohanhi$elm_taco$Types$Person = function (a) {
	return {name: a};
};
var _ohanhi$elm_taco$Types$People = F2(
	function (a, b) {
		return {content: a, totalElements: b};
	});
...
var _ohanhi$elm_taco$Decoders$decodePerson = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'name',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_ohanhi$elm_taco$Types$Person));
var _ohanhi$elm_taco$Decoders$decodePeople = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'totalElements',
	...
	A4(
		...
		'content',
		_elm_lang$core$Json_Decode$list(_ohanhi$elm_taco$Decoders$decodePerson),
		{ctor: '[]'},
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_ohanhi$elm_taco$Types$People)));
...
var _ohanhi$elm_taco$Pages_Ops$viewStargazer = function (stargazer) {
	return A2(
...
var _ohanhi$elm_taco$Pages_Ops$viewStargazers = F2(
	function (taco, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Success':
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						_ohanhi$elm_taco$Pages_Ops$viewStargazer,
						_elm_lang$core$List$reverse(_p0._0)));
			default:
				return _elm_lang$html$Html$text('');
		}
	});
var _ohanhi$elm_taco$Pages_Ops$formatTimestamp = F2(
	function (taco, date) {
...
var _ohanhi$elm_taco$Pages_Ops$viewPerson = F2(
	function (taco, person) {
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
...
var _ohanhi$elm_taco$Pages_Ops$viewPeople = F2(
	function (taco, model) {
		var _p2 = model.people;
		switch (_p2.ctor) {
			case 'Loading':
				return _elm_lang$html$Html$text('加载中');
			case 'Failure':
				return _elm_lang$html$Html$text('加载失败');
			case 'Success':
				return A2(
					_elm_lang$html$Html$ul,
					{
					...
					A2(
						_elm_lang$core$List$map,
						_ohanhi$elm_taco$Pages_Ops$viewPerson(taco),
						_p2._0.content));
			default:
				return _elm_lang$html$Html$text('');
		}
	});
var _ohanhi$elm_taco$Pages_Ops$viewCommit = F2(
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_ohanhi$elm_taco$Pages_Ops$formatTimestamp, taco, commit.date)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _ohanhi$elm_taco$Pages_Ops$viewCommits = F2(
	function (taco, model) {
		var _p3 = model.commits;
		switch (_p3.ctor) {
			case 'Loading':
				return _elm_lang$html$Html$text(
					A2(_ohanhi$elm_taco$I18n$get, taco.translations, 'status-loading'));
			...
			case 'Success':
				return A2(
					...
					A2(
						_elm_lang$core$List$map,
						_ohanhi$elm_taco$Pages_Ops$viewCommit(taco),
						A2(
...
var _ohanhi$elm_taco$Pages_Ops$get = _ohanhi$remotedata_http$RemoteData_Http$getWithConfig(_ohanhi$remotedata_http$RemoteData_Http$defaultConfig);
var _ohanhi$elm_taco$Pages_Ops$Model = F3(
	function (a, b, c) {
		return {commits: a, stargazers: b, people: c};
	});
var _ohanhi$elm_taco$Pages_Ops$ReloadData = {ctor: 'ReloadData'};
var _ohanhi$elm_taco$Pages_Ops$view = F2(
	function (taco, model) {
		return A2(
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_ohanhi$elm_taco$Pages_Ops$ReloadData),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://github.com/Numberartificial/cibops/'),
									_1: {ctor: '[]'}
								}
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Numberartificial/cibops'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
											...
											_1: {
												...
												_0: A2(
													...
													},
													{
														...
														_1: {
															ctor: '::',
															_0: A2(_ohanhi$elm_taco$Pages_Ops$viewStargazers, taco, model),
															_1: {ctor: '[]'}
														}
													}),
												_1: {ctor: '[]'}
...
var _ohanhi$elm_taco$Pages_Ops$HandlePeople = function (a) {
	return {ctor: 'HandlePeople', _0: a};
};
var _ohanhi$elm_taco$Pages_Ops$fetchPeople = A3(_ohanhi$elm_taco$Pages_Ops$get, 'http://168.35.6.12:8099/aic/api/people', _ohanhi$elm_taco$Pages_Ops$HandlePeople, _ohanhi$elm_taco$Decoders$decodePeople);
var _ohanhi$elm_taco$Pages_Ops$HandleStargazers = function (a) {
	return {ctor: 'HandleStargazers', _0: a};
};
var _ohanhi$elm_taco$Pages_Ops$fetchStargazers = A3(_ohanhi$elm_taco$Pages_Ops$get, 'https://api.github.com/repos/Numberartificial/cibops/stargazers', _ohanhi$elm_taco$Pages_Ops$HandleStargazers, _ohanhi$elm_taco$Decoders$decodeStargazerList);
var _ohanhi$elm_taco$Pages_Ops$HandleCommits = function (a) {
	return {ctor: 'HandleCommits', _0: a};
};
var _ohanhi$elm_taco$Pages_Ops$fetchCommits = A3(_ohanhi$elm_taco$Pages_Ops$get, 'https://api.github.com/repos/Numberartificial/cibops/commits', _ohanhi$elm_taco$Pages_Ops$HandleCommits, _ohanhi$elm_taco$Decoders$decodeCommitList);
var _ohanhi$elm_taco$Pages_Ops$fetchData = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: _ohanhi$elm_taco$Pages_Ops$fetchCommits,
		_1: {
			ctor: '::',
...
var _ohanhi$elm_taco$Pages_Ops$init = {
	ctor: '_Tuple2',
	_0: {commits: _krisajenkins$remotedata$RemoteData$Loading, stargazers: _krisajenkins$remotedata$RemoteData$Loading, people: _krisajenkins$remotedata$RemoteData$Loading},
	_1: _ohanhi$elm_taco$Pages_Ops$fetchData
};
var _ohanhi$elm_taco$Pages_Ops$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'ReloadData':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{people: _krisajenkins$remotedata$RemoteData$Loading, commits: _krisajenkins$remotedata$RemoteData$Loading, stargazers: _krisajenkins$remotedata$RemoteData$Loading}),
					_1: _ohanhi$elm_taco$Pages_Ops$fetchData
				};
			case 'HandleCommits':
				return {
...
var _ohanhi$elm_taco$Pages_Home$fetchStargazers = A3(_ohanhi$elm_taco$Pages_Home$get, 'https://api.github.com/repos/Numberartificial/cibops/stargazers', _ohanhi$elm_taco$Pages_Home$HandleStargazers, _ohanhi$elm_taco$Decoders$decodeStargazerList);
var _ohanhi$elm_taco$Pages_Home$HandleCommits = function (a) {
	return {ctor: 'HandleCommits', _0: a};
};
var _ohanhi$elm_taco$Pages_Home$fetchCommits = A3(_ohanhi$elm_taco$Pages_Home$get, 'https://api.github.com/repos/Numberartificial/cibops/commits', _ohanhi$elm_taco$Pages_Home$HandleCommits, _ohanhi$elm_taco$Decoders$decodeCommitList);
...
var _ohanhi$elm_taco$Routing_Helpers$OpsRoute = {ctor: 'OpsRoute'};
...
var _ohanhi$elm_taco$Routing_Helpers$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_ohanhi$elm_taco$Routing_Helpers$OpsRoute,
					_evancz$url_parser$UrlParser$s('ops')),
				_1: {ctor: '[]'}
			}
		}
	});
...
var _ohanhi$elm_taco$Routing_Router$Model = F4(
	function (a, b, c, d) {
		return {opsModel: a, homeModel: b, settingsModel: c, route: d};
	});
...
var _ohanhi$elm_taco$Routing_Router$updateHome = F2(
	function (model, homeMsg) {
		var _p1 = A2(_ohanhi$elm_taco$Pages_Home$update, homeMsg, model.homeModel);
...
var _ohanhi$elm_taco$Routing_Router$OpsMsg = function (a) {
	return {ctor: 'OpsMsg', _0: a};
};
var _ohanhi$elm_taco$Routing_Router$init = function (location) {
	var settingsModel = _ohanhi$elm_taco$Pages_Settings$initModel;
	var _p2 = _ohanhi$elm_taco$Pages_Ops$init;
	var opsModel = _p2._0;
	var opsCmd = _p2._1;
	var _p3 = _ohanhi$elm_taco$Pages_Home$init;
	var homeModel = _p3._0;
	var homeCmd = _p3._1;
	return {
		ctor: '_Tuple2',
		_0: {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _ohanhi$elm_taco$Routing_Router$HomeMsg, homeCmd),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _ohanhi$elm_taco$Routing_Router$OpsMsg, opsCmd),
					_1: {ctor: '[]'}
				}
			})
	};
};
var _ohanhi$elm_taco$Routing_Router$updateOps = F2(
	function (msg, model) {
		var _p4 = A2(_ohanhi$elm_taco$Pages_Ops$update, msg, model.opsModel);
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{opsModel: nextModel}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _ohanhi$elm_taco$Routing_Router$OpsMsg, cmd),
			_2: _ohanhi$elm_taco$Types$NoUpdate
		};
	});
		...
		switch (_p5.ctor) {
			case 'UrlChange':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							route: _ohanhi$elm_taco$Routing_Helpers$parseLocation(_p5._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _ohanhi$elm_taco$Types$NoUpdate
				};
			case 'NavigateTo':
				return {
					...
					_0: model,
					_1: _elm_lang$navigation$Navigation$newUrl(
						_ohanhi$elm_taco$Routing_Helpers$reverseRoute(_p5._0)),
					_2: _ohanhi$elm_taco$Types$NoUpdate
				};
			case 'HomeMsg':
				return A2(_ohanhi$elm_taco$Routing_Router$updateHome, model, _p5._0);
			case 'SettingsMsg':
				return A2(_ohanhi$elm_taco$Routing_Router$updateSettings, model, _p5._0);
			default:
				return A2(_ohanhi$elm_taco$Routing_Router$updateOps, _p5._0, model);
		}
	});
				...
				_0: function () {
					...
					switch (_p6.ctor) {
						...
						case 'OpsRoute':
							return A2(
								_elm_lang$html$Html$map,
								_ohanhi$elm_taco$Routing_Router$OpsMsg,
								A2(_ohanhi$elm_taco$Pages_Ops$view, taco, model.opsModel));
						default:
							return A2(
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_ohanhi$elm_taco$Routing_Router$NavigateTo(_ohanhi$elm_taco$Routing_Helpers$OpsRoute)),
														_1: {
															ctor: '::',
															_0: buttonStyles(_ohanhi$elm_taco$Routing_Helpers$SettingsRoute),
															_1: {ctor: '[]'}
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('数据统计'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
		...
		switch (_p5.ctor) {
			case 'Failure':
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 109, column: 5},
						end: {line: 135, column: 32}
					},
